...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-19 12:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/aded50a5-460e-4221-af43-be72d9f34b62.git
$ cd aded50a5-460e-4221-af43-be72d9f34b62
```
